...
class WelcomeViewController: UIViewController {
    ...
    @objc private func didTapUserButton() {
        let swiftUIUserMode = UserMainContentView()
        let userMode = UIHostingController(rootView: swiftUIUserMode)
        navigationController?.pushViewController(userMode, animated: true)
    }
