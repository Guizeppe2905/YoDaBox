    ...
    var body: some View {
        ZStack {
            Button(action: {
                ...
                Image(uiImage: Constants.Image.cosmetology!)
                    .resizable()
...
struct CosmetologyVideoView: View {
    ...
    var body:  some  View {
        ...
        VideoPlayer (
            ...
            ZStack(alignment: .bottomLeading) {
                ...
                VStack (spacing: 35) {
                    Spacer()
                    if UserDefaults.standard.string(forKey: "industry") == "Fashion" || UserDefaults.standard.string(forKey: "industry") == "Beauty" || UserDefaults.standard.string(forKey: "industry") == "Medicine" {
                  VideoAnimation()
                    } else {
                        Spacer()
