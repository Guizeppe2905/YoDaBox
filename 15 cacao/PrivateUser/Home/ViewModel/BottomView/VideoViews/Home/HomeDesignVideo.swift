    ...
    var body: some View {
        ZStack {
            Button(action: {
                ...
                Image(uiImage: Constants.Image.hdesign!)
                    .resizable()
...
struct HomeDesignVideoView: View {
    ...
    var body:  some  View {
        ...
        VideoPlayer (
            ...
            ZStack(alignment: .bottomLeading) {
                ...
                VStack (spacing: 35) {
                    Spacer()
                    if UserDefaults.standard.string(forKey: "industry") == "Home Design" {
                  VideoAnimation()
                    } else {
                        Spacer()
